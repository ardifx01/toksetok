    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('assets/images/R.png')}}" alt="Logo" srcset=""
                            style="width: 110px; height: 75px; margin-top: -1.5rem;"></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-title" style="font-size: 15px; margin-bottom: -2px; margin-top: 25px;">Management
                </li>
                <!-- Data Barang Link -->
                ...
                <li
                    class="sidebar-item has-sub {{ Route::is('riwayat.index') || Route::is('riwayats') ? 'active': '' }}  ? 'active': '' }}">
                ...
                <li class="sidebar-item {{ Route::is('panduans') ? 'active' : '' }}">
                    <a href="{{ route('panduans') }}" class="sidebar-link">
